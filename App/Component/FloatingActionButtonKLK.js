...
const FloatingActionContainer = ({ onPressPrimary = null, onPressSecondary = null, onSkip = null, disabled = false, variant = 'single', primaryText = 'Simpan', secondaryText = 'Simpan', counter = 0, disabledSkip = true }) => {
  ...
  const singleButtonWithSkip = () => {
    return (
      <>
        <ButtonVariant text='Lewati' containerStyle={[styles.buttonContainer, { marginHorizontal: 16, marginTop: 10, marginBottom: 0, backgroundColor: Colors.WHITE_COLOR }]} textColor={Colors.ORANGE_COLOR} onPress={onSkip} disabled={disabledSkip} />
