  ...
  return (
    <View style={{ marginVertical: 8 }}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 5 }}>
        {!isBottomTitle && title !== '' && <Text style={[{ fontFamily: 'Inter-Regular', fontSize: 15, color: msgError ? '#E01B0E' : '#313339' }, { ...titleStyle }]}>{title}</Text>}
        {
          verified && (
